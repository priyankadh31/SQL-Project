...
select * from swiggy;
use swiggydata;
--- restaurant_no,rating,cost_per_person,price
--- restaurant_name,city,address,cuisine,restaurant_link,menu_catagory,item,  veg_or_nonveg
/*
...
#Q1 01 HOW MANY RESTAURANTS HAVE A RATING GREATER THAN 4.5?
select count(distinct restaurant_name) as high_rated_restaurants
from swiggy
where rating>4.5;

#Q2 02 WHICH IS THE TOP 1 CITY WITH THE HIGHEST NUMBER OF RESTAURANTS?
...
#Q3 02 HOW MANY RESTAURANTS SELL( HAVE WORD "PIZZA" IN THEIR NAME)?
select count(distinct restaurant_name) as pizza_restaurants
from swiggy 
where restaurant_name like '%Pizza%';

#Q4 03 WHAT IS THE MOST COMMON CUISINE AMONG THE RESTAURANTS IN THE DATASET?
...
#Q11 11 LIST THE NAMES OF RESTAURANTS THAT ARE 100% VEGEATARIAN IN ALPHABETICAL ORDER OF RESTAURANT NAME
select distinct restaurant_name
...
#Q12 12 WHICH IS THE RESTAURANT PROVIDING THE LOWEST AVERAGE PRICE FOR ALL ITEMS?
...
#Q14WHICH RESTAURANT PROVIDES THE HIGHEST PERCENTAGE OF NON-VEGEATARIAN FOOD?
select distinct restaurant_name,
...
#Q15 15 Determine the Most Expensive and Least Expensive Cities for Dining:
...
#Q1616 Calculate the Rating Rank for Each Restaurant Within Its City
